...
class MyWindow(QtWidgets.QWidget):
    def __init__(self):
        ...
        if self.image.load(r"\\dtc-fs\marktest\tool\测试数据\2k4k8k长图\2\美女\2\白色衬衫长发清纯美女壁纸.jpg"):  # 如果载入图片,则
            self.imgLabel.setPixmap(QPixmap.fromImage(self.image).scaled(500, 300))  # 显示图片
